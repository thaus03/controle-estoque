...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <a class="navbar-brand" href="index.php">Estoque Hinode</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item">
        <a class="nav-link active" href="produto-formulario.php">Adiciona Produtos <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<!-- <div class="navbar  ">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="produto-lista.php">Produto</a></li> 
            </ul>
        </div>
    </div>
</div> -->
